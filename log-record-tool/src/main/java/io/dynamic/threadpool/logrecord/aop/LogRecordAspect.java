package io.dynamic.threadpool.logrecord.aop;
...
import io.dynamic.threadpool.logrecord.model.LogRecordOps;
import io.dynamic.threadpool.logrecord.model.MethodExecuteResult;
...
import io.dynamic.threadpool.logrecord.service.OperatorGetService;
            ...
            try {
                ...
                if (logConditionPassed(operation.getCondition(), expressionValues)) {
                    LogRecordInfo logRecordInfo = LogRecordInfo.builder()
                            .tenant(StringUtils.isEmpty(environment.getProperty("tenant")) ? environment.getProperty("tenant") : "dtp")
